            ...
            <ItemTemplate>
                <tr>
                    <td style="padding-left:12px;">
                        <asp:CheckBox ID="chkFinished" runat="server" AutoPostBack="true"
                    ...
                    <td style="padding-left:20px;">
                        <asp:CheckBox ID="chkInProgress" runat="server" AutoPostBack="true"
                    ...
                    <td style="padding-left:25px;">
                        <asp:CheckBox ID="chkNeedToListen" runat="server" AutoPostBack="true"
                    ...
                    <td>
                        <%# (((KeyValuePair<Core.DomainObjects.IShow,Core.DomainObjects.IListenedShow>)Container.DataItem)).Key.GetShowName() %>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
